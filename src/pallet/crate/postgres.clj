...
(defn package-source
  ...
  (let [os-family (session/os-family session)]
    (cond
     (and (= :debian os-family) (.startsWith version "9.0")) :debian-backports
     (and (= :ubuntu os-family) (.startsWith version "9.0")) :martin-pitt-backports
     (and (= :centos os-family) (.startsWith version "9.0")) :pgdg
     (and (= :fedora os-family) (.startsWith version "9.0")) :pgdg
     :else :native)))
